...
const verifyEndpoint =
  'https://eqe90bcod2.execute-api.eu-west-1.amazonaws.com/live/ECSD-QA-tech-test';
const paperStyle = {
  padding: 10,
  height: 500,
  flex: 1,
        ...
        <Paper style={paperStyle} zDepth={2}>
          ...
          <Paper style={answerStyle}>
            <TextField
              ...
              underlineShow={false}
              onChange={(event, value) => this.handleText(event, value, 'answer-1')}
            />
            <Divider />
            <TextField
              ...
              underlineShow={false}
              onChange={(event, value) => this.handleText(event, value, 'answer-2')}
            />
            <Divider />
            <TextField
              ...
              underlineShow={false}
              onChange={(event, value) => this.handleText(event, value, 'answer-3')}
            />
            <Divider />
            <TextField
              ...
              hintText="Your Name"
              underlineShow={false}
              onChange={(event, value) => this.handleText(event, value, 'challenger-name')}
            />
          </Paper>
          ...
          <p>
            Please be aware this challenge is not about spamming the api to get the correct answers,

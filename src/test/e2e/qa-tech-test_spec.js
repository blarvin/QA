...
describe('Clicking the first button we find', function () {
  it('Activates a looooong scroll-down', function () {
    ...
    cy.get('body > div > div > section:nth-child(1) > div > div > button:nth-child(1)')
      .click();
  })
...
describe('Making arrays from table data', function () {
  it('Makes THREE arrays of NINE integers each', function () {
    ...
    cy.get('body > div > div > section:nth-child(2) > div > div > div:nth-child(7) > div > div:nth-child(2) > table > tbody > tr:nth-child(1) td')
      .each(function ($element) {
        firstArray.push(parseInt($element.text(), 10))
      })
      .should(function () {
        expect(firstArray).to.be.an('Array').with.lengthOf(9)
      })

    cy.get('body > div > div > section:nth-child(2) > div > div > div:nth-child(7) > div > div:nth-child(2) > table > tbody > tr:nth-child(2) td')
      .each(function ($element) {
        secondArray.push(parseInt($element.text(), 10))
      })

    cy.get('body > div > div > section:nth-child(2) > div > div > div:nth-child(7) > div > div:nth-child(2) > table > tbody > tr:nth-child(3) td')
      .each(function ($element) {
